  ...
  var v = function (a, b) {
    ...
    o = function (a, b, d) {
      ...
      if (null != d.autointv || b)
        if (d.autointv = clearInterval(d.autointv), !b) return;
  ...
  i.jqBoxSlider.registerAnimator("scrollVert3d,scrollHorz3d", function () {
    ...
    a.transition = function (a) {
      ...
      if (b) return 0 === e && (e = a.reverse ? 360 : -360), a.$currSlide.css("z-index", 1), a.$slides.filter(function (b) {
        ...
        display: "block",
        zIndex: 2
      }), a.$box.css(d + "transform", "translate3d(0, 0, -" + a.translateZ + "px) rotate3d(" + (f ? "1, 0, 0, " : "0, 1, 0, ") + e + "deg)"), 360 === Math.abs(e) && (a.$box.css(d + "transform", "translate3d(0, 0, -" + a.translateZ + "px)"), e = 0), {
        bsangle: e
      };
